...
begin
  ...
  if v_normalized_code !~ '^[ABCDEFGHJKLMNPQRSTUVWXYZ23456789]{6}$'
    or target_room.code <> v_normalized_code
  then
    raise exception 'Lesson Session Code is incorrect.' using errcode = 'P0002';
  end if;
